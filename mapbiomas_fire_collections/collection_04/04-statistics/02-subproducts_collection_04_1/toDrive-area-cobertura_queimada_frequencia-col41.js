...
var description = 'csv-col41-burned_cover_frequency-area';
var scale = 30;
...
var mapbiomas = ee.Image('projects/mapbiomas-workspace/FOGO_COL4/2_Subprodutos_col41/mapbiomas-fire-collection41-fire-frequency-coverage-v1');
print(mapbiomas)
// Image area in km2
...
var areas = years.map(
    function (year) {
        var image = mapbiomas.select('fire_frequency_1985_2024');
