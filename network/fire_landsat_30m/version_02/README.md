...
1. Open the [MapBiomas Fire Landsat Burned Area Classification Notebook](https://colab.research.google.com/github/mapbiomas/brazil-fire/blob/main/network/fire_landsat_30m/version_02/mapbiomas_fire_classification_v1.ipynb) on Google Colab.
