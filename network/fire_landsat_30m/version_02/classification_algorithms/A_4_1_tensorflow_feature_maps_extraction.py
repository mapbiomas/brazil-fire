    ...
    for satellite_year in satellite_years:
        ...
        with tqdm (total=len(years), desc=f'Processing years for satellite {satellite.upper()}') as pbar_years:
            for year in years:
                ...
                gcs_filename = f'gs://{bucket_name}/sudamerica/{country}/{collection}/result_embeddings/{image_name}.tif'
                ...
                # Caminho corrigido para a coleção atual no modelo centralizado
